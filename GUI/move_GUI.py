...
class Move_GUI(Toplevel):
    def __init__(self, parent):
        ...
        # Buttons
        button_1 = Button( self, text="Mover", borderwidth=0, highlightthickness=0, command=lambda: print("button_1 clicked"), relief="flat" )
        button_1.place( x=9.0, y=196.0, width=203.0, height=49.0 )

        button_2 = Button( self, text="Cancelar", borderwidth=0, highlightthickness=0, command=lambda: print("button_2 clicked"), relief="flat" )
